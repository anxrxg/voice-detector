"""Convert Common Voice age MP3 files to WAV to avoid decode issues.

- Scans data/age/wav for *.mp3
- Writes *.wav next to each MP3 (same basename)
- Requires ffmpeg

Usage:
  python convert_age_mp3_to_wav.py --project-root . --workers 4

Then train using WAVs only:
  python train.py --task age --age-labels data/age/age_labels.csv --num-workers 4
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Convert age MP3s to WAV")
